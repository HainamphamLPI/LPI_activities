...
elapsed_time = 0
last_score_time = 0
countdown_time = 1  # Set to 2 seconds for each score countdown
...
squares = [
    {'x': 300, 'y': 300, 'size': 100},  # Top-left corner
    {'x': 1500, 'y': 300, 'size': 100},  # Top-right corner
    {'x': 300, 'y': 650, 'size': 100},  # Bottom-left corner
    {'x': 1500, 'y': 650, 'size': 100}  # Bottom-right corner
]
...
while True:
    if not game_running and not game_over:
        ...
        if key == ord('r'):
            ...
            trackers_boxes = []  # Clear all bounding boxes
        elif key == ord('q'):
            break

    # Wait for 10ms for keypresses
